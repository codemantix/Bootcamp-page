...
export default function PricingSection() {
  ...
  return (
    <section id="pricing" className="w-full py-16 md:py-[87px] bg-white xl:mb-8 xl:h-[1024px]">
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 xl:px-[276px]">
        {/* Section Heading */}
        <Reveal className="flex flex-col items-start max-w-[672px] w-full md:w-[584px]">
          {/* Tag */}
        ...
        <div className="flex min-w-0 flex-col gap-8 mt-14 md:mt-[101px] items-center xl:flex-row">
          {/* Card 1 - Early Bird (filled button) */}
          <motion.div
            initial={reduced ? false : { opacity: 0, y: 32 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} whileHover={reduced ? undefined : { y: -7 }} transition={{ type: "spring", stiffness: 300, damping: 26 }}
            className="premium-card relative bg-[rgba(233,235,243,0.35)] rounded-[20px] p-6 sm:p-[28px] shadow-[0_4px_4px_rgba(0,0,0,0.05)] w-full max-w-[400px] h-auto md:h-[551px] flex flex-col justify-between overflow-hidden"
          >
            {/* Top Section */}
          ...
          <motion.div initial={reduced ? false : { opacity: 0, y: 32 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} whileHover={reduced ? undefined : { y: -7 }} transition={{ type: "spring", stiffness: 300, damping: 26, delay: reduced ? 0 : .08 }} className="premium-card relative bg-[rgba(233,235,243,0.35)] rounded-[20px] p-6 sm:p-[28px] shadow-[0_4px_4px_rgba(0,0,0,0.05)] w-full max-w-[400px] h-auto md:h-[551px] flex flex-col justify-between overflow-hidden">
            {/* Standard Pill Tag */}
